...
```
[BURAYA_KENDI_EPOSTAN]
```

Gerçek ve düzenli kontrol ettiğin bir adres olmalı — Shopify test amaçlı buraya mail atabiliyor.

## Privacy policy URL

```
https://[RAILWAY_ADRESIN]/gizlilik-politikasi
```

## Demo store URL (opsiyonel ama önerilir)

Kendi test mağazanı halka açık gösterime hazırlarsan (parola korumasını kaldırarak) buraya ekleyebilirsin. Zorunlu değil ama incelemeyi hızlandırır.

---

## Ekran görüntüleri — 3 ila 6 adet, 1600x900 px, PNG veya JPG
...
- [ ] Gizlilik politikası sayfası gerçekten açılıyor mu? (`/gizlilik-politikasi` adresini tarayıcıda dene)
- [ ] Destek e-postası çalışıyor mu?
- [ ] Uygulama adı App Store'da başka biri tarafından kullanılmıyor mu?
- [ ] En az 3 ekran görüntüsü hazır mı?
- [ ] 1200x1200 ikon hazır mı?
- [ ] Kendi test mağazanda uygulamayı kurup denedin mi? (İnceleme ekibi bunu yapacak)
